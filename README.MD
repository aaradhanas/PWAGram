...
4. If the service worker code is changed, the installation event gets triggered, but the activation does not happen until all the opened tabs of the app are closed and reopened.
